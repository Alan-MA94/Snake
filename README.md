# 🐍 Slightly Bugged PySnake Game

A classic Snake game implementation in Python, with a few intentional quirks to keep things interesting! Built with modular components for easy maintenance and features.

## 🎮 Features

- **Classic snake mechanics** - Eat food, grow longer, avoid walls and yourself
- **Score tracking** - Keep track of your high scores
- **Modular design** - Separate classes for snake, food, and score management
...
Want to fix the bugs or add features? Feel free to fork and submit PRs! The code is modular and well-commented.

## 📝 License

This project is open source and available for anyone to learn from or improve.

## 🙏 Acknowledgments

Thanks to everyone who enjoys slightly buggy snake games

- Built with Python and determination
- Inspired by classic Nokia snake games
